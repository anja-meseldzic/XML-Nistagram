...
@Component({
  selector: 'app-disliked-data',
  templateUrl: './disliked-data.component.html',
  styleUrls: ['./disliked-data.component.css']
})
export class DislikedDataComponent implements OnInit {

  posts : Post[] = [];
  constructor(private mediaService : MediaService, private router : Router, private snackBar : MatSnackBar) { }

  ngOnInit(): void {
    this.mediaService.getDislikedContent().subscribe(
